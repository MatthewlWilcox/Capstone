...
9. How does =betting odds relate to the individual teams positions? This will be a scatterplot with the difference between position and the difference between bettign odds for a team. 
...
14. How can all these factors be used to predict the attendance outcome of these games? Here I will be making models with two different outcomes one being the exact attendance figure and the other focusing on percentage of the stadium capicity filled. Three different modeling methodolgoy will be used. The first attempted will be a linear model, the second will be a polnomial regressiojn mode and the third will be a decision tree regression model. The variables looking to be used are the league, the home team, the away team, the postions(difference between the postion of the home team and away team as well as the position of just the home team), the betting odds for that individual game, odds for number of goals scored, and the time/date of the match.
