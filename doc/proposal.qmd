...
Two data sets were used. the first was from Football-data.co.uk and that contained the betting data for individual games. The second was scraped from Worldfootball.net and involves the individual match data


* attendance: the number of fans attending games 
...
* Presentation prep and practice (3 hours)
